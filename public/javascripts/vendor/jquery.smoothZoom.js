// Modified plugin by F R A W L 3 Y
// SEARCH for HACK
/*
        ...
        ***********************************************************/
        ...
        if (!this.bu_icon) {
            ...
            if (this.bu_icon == 'none') {
                ...
                // HACK set the zoom icon path.  Setting a .smooth_zoom_icons background
                // image didn't work...
                this.bu_icon = '/public/images/megaslab/zoom_icons.png';
            }
            testOb.remove();
        }
        ...
        //HACK - comment out loading the main image.  We split the image into 4.
        this.$image.hide();
        this.imgList = [
    ...
    Zoomer.prototype = {
        ...
        ***********************************************************************************************************************/
        init: function () {
            ...
            //Buttons Container		
            //HACK - add class of megaslab-zoom-btns
            $controls = $(
				'<div class="megaslab-zoom-btns" style="position: absolute; ' + hProp + ':' + hVal + 'px; ' + vProp + ': ' + vVal + 'px; width: ' + cBW + 'px; height: ' + cBH + 'px; z-index: 20;" class="noSel;">\
